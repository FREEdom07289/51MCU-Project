...
| 模块 | 状态 | 完成日期 | 说明 |
|------|:---:|------|------|
| 01-LED | ✅ 完成 | 2026-07-01 | 点亮LED + LED闪烁 + 流水灯（3种方法）+ 2个练习 |
| 02-按键 | ✅ 完成 | 2026-07-08 | 按键消抖 + K1启停控制 + K2方向切换 |
| 03-数码管 | ⏳ 待开始 | - | 数码管显示 |
| 04-定时器 | ⏳ 待开始 | - | 定时器/计数器 |
| 05-中断 | ⏳ 待开始 | - | 中断系统 |
...
- [[按键]](notes/按键.md) — 按键消抖原理、模板代码、实战代码（✅ 完成）
...
1. 开始**数码管**模块学习（静态显示 → 动态扫描）
2. 学习**定时器**实现精确延时（替代软件延时）
